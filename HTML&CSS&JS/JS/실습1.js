...
// JavaScript 기초
// ============================================
// JavaScript는 웹 페이지에 동적 기능을 추가하는 프로그래밍 언어입니다.
...
// 🔥 연습 문제
// ============================================
// 1. 자신의 이름, 나이, 취미를 변수에 저장하고 템플릿 리터럴로 출력하기
// 2. 두 개의 숫자를 변수에 저장하고 사칙연산 결과 출력하기
// 3. 온도를 섭씨(Celsius)로 저장하고, 화씨(Fahrenheit)로 변환하기
//    공식: F = C * 9/5 + 32