# -*- coding: utf-8 -*-
"""
15.image_processing_advanced.py
================================================================================
[대주제] 영상처리 심화 (회전/원근/문서스캐너/엣지/윤곽선/히스토그램/모폴로지)
...
실행 방식
--------------------------------------------------------------------------------
python ./AI/수업자료/15.image_processing_advanced.py --list
python ./AI/수업자료/15.image_processing_advanced.py --demo 02 --image ./Images/doc.jpg
python ./AI/수업자료/15.image_processing_advanced.py --demo 03 --source 0
